# V4 AI EDGE PRIVACY AND SAFETY GUIDE v4.7.0-real
...
This guide remains compatible with v4.7.0-real. Existing v2/v3/v4 features are preserved while AI News Odds adds review-only source-weighted draft fair-probability context.
