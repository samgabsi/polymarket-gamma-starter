# V4 Market Detail Drilldown Guide - v4.6.0-real

Market Detail / Opportunity Review pages show YES/NO prices, model fair source, edge explanation, family rank, AI Edge lifecycle, operator notes, and audit history.
