# V4 Plugin Boundary Guide — v4.4.0-real

## Summary

v4.4.0-real preserves metadata-only plugin manifests and adds stronger compatibility checks. This is not executable plugin support.
...
v4.4.0-real validates and displays manifests only. It does not provide executable plugins or dynamic route loading.
