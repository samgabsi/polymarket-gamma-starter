# News Evidence Packet Guide - v4.7.0-real
...
Evidence packets include query plans, source records, source weights, duplicate groups, claim clusters, contradictions, events, before/after fair probabilities, warnings, and safety flags. Runtime evidence records are excluded from release ZIPs.
