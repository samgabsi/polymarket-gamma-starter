# V4 Plugin Boundary Guide - v4.6.0-real
...
# Plugin Boundary Guide - v4.6.0-real

Plugin manifests remain metadata-only. v4.5 market-edge recommendations, AI Edge packet links, and family rankings do not grant plugins live order, cancellation, secret, remote-code, or network-by-default capabilities.
