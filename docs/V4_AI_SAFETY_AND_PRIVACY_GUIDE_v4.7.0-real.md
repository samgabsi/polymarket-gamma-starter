# AI Safety and Privacy Guide - v4.7.0-real
...
No private keys, wallet secrets, auth headers, session cookies, user passwords, sensitive account data, or real API keys may be sent to model providers or included in releases. Runtime AI news odds records are excluded from release ZIPs.
