# AI News Odds Prompt Governance Guide - v4.7.0-real
...
### Search planning
Return source-backed search queries. Do not include secrets, account data, wallet data, private keys, auth headers, cookies, or trade instructions.

### Source summarization
Summarize facts, dates, source type, cited URL, and uncertainty. Do not invent citations or market data.

### Claim extraction
Extract materially relevant claims, stance, contradiction indicators, and resolution relevance. Return structured JSON.

### Contradiction detection
Flag disputes, denials, rumors, stale evidence, and source limitations.

### Event impact estimation
Estimate direction and magnitude as draft research only; deterministic code applies final caps.

### Operator summary
Explain before/after fair probability, source weights, contradictions, and why output is not financial advice or trade approval.
