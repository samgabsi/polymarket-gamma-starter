# Polymarket OP Console Operator Manual - v4.12.0-real
...
Plan `runtime_migration_plan_v4_3_0` is dry-run only from `4.2.0-real` to `4.12.0-real`. Automatic runtime migration is `False`.
...
- docs/RELEASE_NOTES_v4.12.0-real.md
- docs/VALIDATION_v4.12.0-real.md
- docs/OPERATOR_ACCEPTANCE_CHECKLIST.md
- docs/STUB_BURNDOWN_MAP_v4.12.0-real.md
- docs/V4_FUNCTIONAL_COMPLETION_GUIDE_v4.12.0-real.md
- docs/V4_CONFIGURABLE_AI_ODDS_ADJUSTMENT_GUIDE_v4.12.0-real.md
- docs/V4_CROSS_MARKET_ARBITRAGE_GUIDE_v4.12.0-real.md
- docs/RELEASE_CHECKLIST_v4.12.0-real.md
