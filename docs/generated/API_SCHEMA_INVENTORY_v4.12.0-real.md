# API Schema Inventory - v4.12.0-real
...
| cross_market_arbitrage | Cross-Market Arbitrage APIs | /api/v3/arbitrage | cross_market_arbitrage | False | /docs/V4_CROSS_MARKET_ARBITRAGE_GUIDE_v4.12.0-real.md |
