# Polymarket OP Console Operator Manual - v4.5.0-real
...
Polymarket OP Console is a local-first, human-in-the-loop console for research, paper workflows, live-control readiness, datasets, freshness planning, simulation, analytics, tasks, guided reviews, cockpit navigation, v4 platform diagnostics, AI-assisted draft review, and AI Edge Research.
...
Plan `runtime_migration_plan_v4_3_0` is dry-run only from `4.2.0-real` to `4.5.0-real`. Automatic runtime migration is `False`.
...
- docs/V4_OPENAI_INTEGRATION_GUIDE_v4.5.0-real.md
- docs/V4_LOCAL_LLM_RUNTIME_GUIDE_v4.5.0-real.md
- docs/V4_AI_OPERATOR_COPILOT_GUIDE_v4.5.0-real.md
- docs/V4_AI_PROMPT_GOVERNANCE_GUIDE_v4.5.0-real.md
- docs/V4_AI_SAFETY_AND_PRIVACY_GUIDE_v4.5.0-real.md
- docs/V4_AI_EDGE_RESEARCH_GUIDE_v4.5.0-real.md
- docs/V4_AI_WEB_SEARCH_RESEARCH_GUIDE_v4.5.0-real.md
- docs/V4_AI_EVIDENCE_PACKET_GUIDE_v4.5.0-real.md
- docs/V4_AI_MODEL_CALIBRATION_GUIDE_v4.5.0-real.md
- docs/V4_OPENAI_WEB_SEARCH_EDGE_GUIDE_v4.5.0-real.md
- docs/V4_LOCAL_LLM_EDGE_REVIEW_GUIDE_v4.5.0-real.md
- docs/V4_AI_EDGE_CALIBRATION_GUIDE_v4.5.0-real.md
- docs/V4_AI_EDGE_PRIVACY_AND_SAFETY_GUIDE_v4.5.0-real.md
- docs/V4_CHATGPT_CONNECTOR_BLUEPRINT_v4.5.0-real.md
- docs/V4_ROUTER_ARCHITECTURE_GUIDE_v4.5.0-real.md
- docs/V4_API_CONTRACTS_GUIDE_v4.5.0-real.md
- docs/V4_API_SCHEMA_GUIDE_v4.5.0-real.md
- docs/V4_RUNTIME_MIGRATION_PLANNER_GUIDE_v4.5.0-real.md
- docs/V4_PLATFORM_ARCHITECTURE_GUIDE_v4.5.0-real.md
- docs/V3_OPERATOR_COCKPIT_GUIDE_v4.5.0-real.md
- docs/V3_GUIDED_OPERATOR_WORKSPACE_GUIDE_v4.5.0-real.md
- docs/V3_OPERATOR_TASK_PLANNER_GUIDE_v4.5.0-real.md
- docs/V3_DATASET_BUILDER_GUIDE_v4.5.0-real.md
- docs/V3_FRESHNESS_SCHEDULER_GUIDE_v4.5.0-real.md
- docs/V3_SIMULATION_LAB_GUIDE_v4.5.0-real.md
- docs/V3_OPERATOR_ANALYTICS_GUIDE_v4.5.0-real.md
