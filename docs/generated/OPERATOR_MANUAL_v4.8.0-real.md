# Polymarket OP Console Operator Manual - v4.9.0-real
...
Plan `runtime_migration_plan_v4_3_0` is dry-run only from `4.2.0-real` to `4.9.0-real`. Automatic runtime migration is `False`.
