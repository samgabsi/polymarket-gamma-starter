# Runtime Migration Plan Template - v4.2.0-real

Plan ID: `runtime_migration_plan_v4_2_0`

Source version: `4.1.0-real`

Target version: `4.2.0-real`
...
Before any future v4.x data migration, stop the app and make an operator-controlled backup of package-excluded runtime data. v4.2 only reports recommendations.
...
| mig_09_v3_simulation | v3_simulation | backup recommended | False | Back up before future v4.x migrations; v4.2 does not copy, delete, rewrite, or move this data automatically. |
...
| mig_13_v3_workspace | v3_workspace | backup recommended | False | Back up before future v4.x migrations; v4.2 does not copy, delete, rewrite, or move this data automatically. |
| mig_14_v3_cockpit | v3_cockpit | backup recommended | False | Back up before future v4.x migrations; v4.2 does not copy, delete, rewrite, or move this data automatically. |
