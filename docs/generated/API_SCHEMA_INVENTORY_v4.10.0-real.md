# API Schema Inventory - v4.10.0-real
...
| api_route_count | 846 |
| unnormalized_endpoint_count | 740 |
...
| cross_market_arbitrage | Cross-Market Arbitrage APIs | /api/v3/arbitrage | cross_market_arbitrage | False | /docs/V4_CROSS_MARKET_ARBITRAGE_GUIDE_v4.10.0-real.md |
