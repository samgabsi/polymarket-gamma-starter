# API Schema Inventory - v4.9.0-real
...
| api_route_count | 844 |
| unnormalized_endpoint_count | 738 |
...
| cross_market_arbitrage | Cross-Market Arbitrage APIs | /api/v3/arbitrage | cross_market_arbitrage | False | /docs/V4_CROSS_MARKET_ARBITRAGE_GUIDE_v4.9.0-real.md |
