# Runtime Migration Plan Template - v4.9.0-real

Plan ID: `runtime_migration_plan_v4_3_0`

Source version: `4.2.0-real`

Target version: `4.9.0-real`
...
| mig_07_v3_workflows | v3_workflows | backup recommended | False | Back up before future v4.x migrations; v4.3 does not copy, delete, rewrite, or move this data automatically. |
| mig_08_v3_analytics | v3_analytics | backup recommended | False | Back up before future v4.x migrations; v4.3 does not copy, delete, rewrite, or move this data automatically. |
...
| mig_10_v3_datasets | v3_datasets | backup recommended | False | Back up before future v4.x migrations; v4.3 does not copy, delete, rewrite, or move this data automatically. |
| mig_11_v3_freshness | v3_freshness | backup recommended | False | Back up before future v4.x migrations; v4.3 does not copy, delete, rewrite, or move this data automatically. |
| mig_12_v3_tasks | v3_tasks | backup recommended | False | Back up before future v4.x migrations; v4.3 does not copy, delete, rewrite, or move this data automatically. |
...
| mig_17_v4_ai_edge | v4_ai_edge | no-op | False | No action is required unless you expected local runtime data in this namespace. |
