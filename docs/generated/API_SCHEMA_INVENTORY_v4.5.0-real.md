# API Schema Inventory - v4.5.0-real
...
| api_route_count | 812 |
| unnormalized_endpoint_count | 725 |

## API Families

| Family | Title | Prefixes | Owner | Normalized | Docs |
| --- | --- | --- | --- | --- | --- |
| platform | Platform APIs | /api/v3/platform | platform_* | True | /docs/V4_API_CONTRACTS_GUIDE_v4.5.0-real.md |
| ai | AI Copilot APIs | /api/v3/ai | ai_* | True | /docs/V4_OPENAI_INTEGRATION_GUIDE_v4.5.0-real.md |
| v3_core | V3 Core UX APIs | /api/v3/ux | live_v3 | False | /docs/V4_ROUTER_ARCHITECTURE_GUIDE_v4.5.0-real.md |
| cockpit | Cockpit APIs | /api/v3/cockpit | live_v3_cockpit | False | /docs/V3_OPERATOR_COCKPIT_GUIDE_v4.5.0-real.md |
| workspace | Guided Workspace APIs | /api/v3/workspace | live_v3_workspace | False | /docs/V3_GUIDED_OPERATOR_WORKSPACE_GUIDE_v4.5.0-real.md |
| tasks | Task APIs | /api/v3/tasks | live_v3_tasks | False | /docs/V3_OPERATOR_TASK_PLANNER_GUIDE_v4.5.0-real.md |
| datasets | Dataset APIs | /api/v3/datasets | live_v3_datasets | False | /docs/V3_DATASET_BUILDER_GUIDE_v4.5.0-real.md |
| freshness | Freshness APIs | /api/v3/freshness | live_v3_freshness | False | /docs/V3_FRESHNESS_SCHEDULER_GUIDE_v4.5.0-real.md |
| simulation | Simulation APIs | /api/v3/simulation | live_v3_simulation | False | /docs/V3_SIMULATION_LAB_GUIDE_v4.5.0-real.md |
| analytics | Analytics APIs | /api/v3/analytics | live_v3_analytics | False | /docs/V3_OPERATOR_ANALYTICS_GUIDE_v4.5.0-real.md |
| search_graph_workflows | Search, Graph, and Workflow APIs | /api/v3/search,/api/v3/graph,/api/v3/workflows | live_v3 | False | /docs/V3_OPERATOR_INTELLIGENCE_OS_GUIDE_v4.5.0-real.md |
