# V4 Ai Edge Packet Lifecycle Guide - v4.6.0-real

AI Edge Packet Lifecycle states are DRAFT, EVIDENCE_ATTACHED, AI_ANALYZED, OPERATOR_REVIEWED, NEEDS_MORE_EVIDENCE, ARCHIVED, and EXPORTED.
