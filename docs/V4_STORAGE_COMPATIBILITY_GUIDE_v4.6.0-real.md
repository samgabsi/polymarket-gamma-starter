# V4 Storage Compatibility Guide - v4.6.0-real
...
# Storage Compatibility Guide - v4.6.0-real

v4.5 adds deterministic recommendation display and review-only AI Edge row wiring. It does not require automatic runtime storage migration. Runtime AI Edge packets, evidence, calibration, exports, logs, snapshots, and user data remain excluded from release packaging.
