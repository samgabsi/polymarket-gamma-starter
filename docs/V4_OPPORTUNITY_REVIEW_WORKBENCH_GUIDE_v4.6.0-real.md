# V4 Opportunity Review Workbench Guide - v4.6.0-real

The Opportunity Review Workbench aggregates market candidates, review statuses, AI Edge packet state, operator notes, watchlist state, paper-review state, and review-only actions.
