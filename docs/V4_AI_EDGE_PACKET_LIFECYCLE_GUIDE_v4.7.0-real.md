# AI Edge Packet Lifecycle Guide - v4.7.0-real
...
AI Edge packets can include a News Odds snapshot with source weights, citations, before/after fair odds, before/after edge, and safety flags. Lifecycle states remain draft/review-only.
