# V4 Router Architecture Guide - v4.3.0-real

## Purpose

v4.3.0-real begins path-preserving FastAPI router extraction for Polymarket OP Console. The goal is maintainability without changing public URLs, auth behavior, response compatibility, or backend safety gates.
