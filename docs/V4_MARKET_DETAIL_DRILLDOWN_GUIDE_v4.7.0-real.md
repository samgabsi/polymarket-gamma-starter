# Market Detail Drilldown Guide - v4.7.0-real
...
Market detail pages include a News Odds panel showing base fair YES/NO, market prices, current edge, news-adjusted fair YES/NO, adjusted edge, source counts, warnings, and review-only actions.
