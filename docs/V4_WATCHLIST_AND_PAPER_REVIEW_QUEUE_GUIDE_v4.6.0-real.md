# V4 Watchlist And Paper Review Queue Guide - v4.6.0-real

Watchlist and Paper Review Queue actions update review records only and never create executable live orders.
