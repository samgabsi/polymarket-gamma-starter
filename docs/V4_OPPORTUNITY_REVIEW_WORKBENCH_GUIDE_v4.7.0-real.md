# Opportunity Review Workbench Guide - v4.7.0-real
...
The workbench now includes News Odds status, adjusted fair probability, news confidence, top source, contradiction warnings, and last researched time where available. Review states remain workflow-only.
