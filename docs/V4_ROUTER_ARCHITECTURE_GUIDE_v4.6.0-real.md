# V4 Router Architecture Guide - v4.6.0-real
...
# Router Architecture Guide - v4.6.0-real

v4.5 preserves the v4 router split and adds market-edge APIs in `app/main.py` plus AI Edge market-row APIs in `app/routers/ai.py`. Aliases are metadata/navigation conveniences only.

# Platform Architecture Guide - v4.6.0-real
