# V3 OPERATOR COCKPIT GUIDE v4.4.0-real
...
v4.4.0-real adds the **Multi-Panel Operator Cockpit, Keyboard Navigation, and Review Layout System**. The cockpit is a local-first operator workspace for moving quickly between tasks, guided reviews, source previews, dependency chains, packets, datasets, freshness findings, simulations, analytics, governance, monitoring, research, and portfolio context.
