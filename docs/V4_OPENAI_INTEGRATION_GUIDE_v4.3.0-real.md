# OpenAI Integration Guide - v4.3.0-real

Polymarket OP Console v4.3.0-real adds Multi-provider AI Copilot support as a draft-only review layer. It is disabled and dry-run-only by default.
